...
-- 5. Criar sequence para role_assignments primeiro
CREATE SEQUENCE IF NOT EXISTS public.role_assignments_id_seq;

-- 6. Criar tabela role_assignments se não existir
